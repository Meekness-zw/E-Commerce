    ...
    <div>
      <div className="bg-[#F2F0F1]">
        <div className="md:grid md:grid-cols-2">
          <div>
            <h1 className="font-extrabold text-[35px] ml-5 pt-10">
              FIND CLOTHES THAT MATCHES YOUR STYLE
            </h1>
            <p className="text-gray-500 ml-5 mt-3 text-[15px] font-thin">
              ...
              <div className=" space-x-5 mt-10 w-[70%] md:w-[100%]">
                <div className="flex">
                  <div className="text-center">
                    <h2 className="font-extrabold flex-col text-[35px] md:text-[20px] mr-10">
                      {brands}+{" "}
                      <span className="font-medium text-[15px] md:text-[10px] text-gray-500 block">
                  ...
                  <div className="text-center">
                    <h2 className="ml-5 font-extrabold flex-col md:text-[20px] text-[35px] md:ml-0">
                      {products}+{" "}
                      <span className="font-medium text-[15px] text-gray-500 md:text-[10px] block">
                        High Quality Products
                      </span>
                    </h2>
                  </div>
                  <div className="text-center hidden md:block">
                    <h2 className="font-extrabold flex-col ml-10 md:text-[20px] text-[35px]">
                      {customers}+{" "}
                      <span className="font-medium text-[15px] text-gray-500 md:text-[10px] block">
                        Happy Customers
                      </span>
                ...
                <div className="text-center mb-10 md:hidden">
                  <h2 className="font-extrabold flex-col md:text-[20px] text-[35px]">
                    {customers}+{" "}
                    <span className="font-medium text-[15px] text-gray-500 md:text-[10px] block">
                      Happy Customers
                    </span>
      ...
      <div className="overflow-hidden lg:w-[100%] flex flex-col items-center">
        <div className="text-center">
          <h1 className="font-extrabold text-[40px] mt-10 mb-10">
            NEW ARRIVALS
          </h1>
        </div>

        <div className="w-[100%] flex flex-wrap gap-3 justify-center">
          <Stock
            item={Tshirt}
            imgAlt="img"
            type="T-shirt with tape details"
            star={Star}
            rating="4.5 /5"
            cost="$120"
            discount=""
      ...
      <div>
        <h1 className="font-extrabold text-[40px] mt-10 mb-10 ml-5">
          OUR HAPPY CUSTOMERS
        </h1>
